...
async function renderSearchResultItem(item) {
  ...
  `;
      itemDiv.addEventListener('click', async (event) => {
        ...
        const path = window.location.pathname;
        const listPath = `/tasks/${currentUserId}/list/${project.objectID}`;
        const boardPath = `/tasks/${currentUserId}/board/${project.objectID}`;
        const dashboardPath = `/tasks/${currentUserId}/dashboard/${project.objectID}`;
    ...
    case 'task':
      ...
      itemDiv.addEventListener('click', async (event) => {
        ...
        const path = window.location.pathname;
        const listPath = `/tasks/${currentUserId}/list/${task.projectId}`;
        const boardPath = `/tasks/${currentUserId}/board/${task.projectId}`;
        const dashboardPath = `/tasks/${currentUserId}/dashboard/${task.projectId}`;

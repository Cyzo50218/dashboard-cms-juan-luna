...
(function initializeDrawer() {
    ...
    onAuthStateChanged(auth, async (user) => {
        ...
        unsubscribeUserDoc = onSnapshot(userDocRef, async (userSnap) => {
            ...
            // 3. Attach a new real-time onSnapshot listener to this workspace
            console.log(`Setting up real-time listener for workspace: ${activeWorkspaceId}`);
            unsubscribeWorkspace = onSnapshot(workspaceDocRef, (workspaceSnap) => {
                if (workspaceSnap.exists()) {
                    ...
                    // Toggle Inventory link visibility
                    ...
                    // Toggle Products link visibility
